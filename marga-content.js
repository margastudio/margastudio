...
function init() {
    ...
    const observer = new MutationObserver(() => {
      const switcherMissing = !document.querySelector('.marga-language-switcher');
      if (!hasStalePlaceholders() && !switcherMissing) return;
